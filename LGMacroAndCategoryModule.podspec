...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ModulerTest/PrivatePods.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dropkai@163.com' => 'dropkai@163.com' }
  s.source           = { :git => 'https://github.com/ModulerTest/PrivatePods.git', :tag => s.version }
